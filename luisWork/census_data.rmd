...
```
http://api.census.gov/data/2010/sf1?key=9742d20e8417b6f58f37c8e970e567881b9d0aca&get=P0010001,NAME&for=county:*
...
```{r}
#save.image('~/Documents/CUNY/data_class/project-final/finalProj.RData')
load('~/Documents/CUNY/data_class/project-final/finalProj.RData')
```
...
**propose working with three year steps; run a regression on a lag: income per capita is a backyear and the population is measured from a later year, ex. income is from 2010 and population metric is for 2011**

```{r}
api_key <- readLines("~/Documents/CUNY/data_class/project-final/census_api_key") [[1]]
...
#long format: 6 pieces of data per county - 3,087 counties
...
#contains population and income info: one obs. per county
...
**Clearly a quadratic relationship**
```{r}
